...
{
    Task EnsureServiceStoppedAsync(string serviceName, CancellationToken cancellationToken = default);
    Task ShutdownDeviceAsync(CancellationToken cancellationToken = default);
